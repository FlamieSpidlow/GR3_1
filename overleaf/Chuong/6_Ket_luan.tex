...
Bộ sinh bảng và các chức năng lõi cũng đã được đánh giá bằng số liệu đo thực tế: bộ sinh bảng tạo được 84/84 màn hợp lệ cho 28 chủ đề (780 từ) với tỉ lệ đặt từ 84,6\% và thời gian trung bình khoảng 3,1\,ms mỗi màn, đồng thời 14/14 trường hợp kiểm thử chức năng đều đạt trong đợt chạy kiểm thử tự động.

Tuy nhiên, sản phẩm vẫn còn một số hạn chế. Dữ liệu từ vựng hiện được nhúng trực tiếp trong mã nguồn nên việc mở rộng hoặc chỉnh sửa nội dung chưa thuận tiện. Ứng dụng chưa có công cụ biên tập chủ đề và chưa hỗ trợ đồng bộ dữ liệu qua mạng. Kiểm thử mới dừng ở mức chức năng tự động và quan sát giao diện ở một độ phân giải; phần đánh giá trải nghiệm người dùng vẫn cần được thực hiện thêm với người chơi thực tế.
...
So với mục tiêu ban đầu, đồ án đã hoàn thành phần lõi của sản phẩm: có dữ liệu chủ đề, có sinh bảng, có giao diện chơi, có kiểm tra đáp án, có gợi ý, có điểm và có lưu tiến độ; đồng thời đã có ảnh minh họa các màn hình thực tế, số liệu đo bộ sinh bảng và kết quả kiểm thử chức năng. Những phần còn thiếu chủ yếu thuộc nhóm hoàn thiện sản phẩm và đánh giá với người dùng thực tế, bao gồm tách dữ liệu khỏi mã nguồn, bổ sung nội dung và thu thập phản hồi người chơi.
...
\thesistodo{nếu sau này tổ chức được khảo sát người dùng thực tế, bổ sung số liệu trải nghiệm vào phần kết luận để tăng độ thuyết phục.}
