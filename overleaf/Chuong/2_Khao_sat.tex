...
\thesistodo{vẽ biểu đồ use case tổng quát tại đây. Biểu đồ nên có tác nhân ``Người chơi'' kết nối tới các use case: Quản lý tài khoản, Chọn chủ đề, Chọn màn chơi, Xem gợi ý, Nhập đáp án, Sử dụng gợi ý, Xem kết quả, Chơi lại, Quay về menu. Có thể thêm tác nhân phụ ``Hệ thống'' hoặc ghi chú hệ thống tự thực hiện Lưu tiến độ và Sinh bảng ô chữ.}
...
Các use case tổng quát có thể được phân rã theo bốn nhóm chính: nhóm tài khoản, nhóm chủ đề và màn chơi, nhóm gameplay, và nhóm tiến độ. Nhóm tài khoản gồm tạo, chọn và xóa tài khoản cục bộ. Nhóm chủ đề và màn chơi gồm chọn chủ đề, xem danh sách màn và bắt đầu màn chơi. Nhóm gameplay gồm xem gợi ý, nhập đáp án, kiểm tra đáp án và dùng gợi ý. Nhóm tiến độ gồm lưu kết quả, tải lại tiến độ và hiển thị trạng thái hoàn thành.

\thesistodo{vẽ biểu đồ use case phân rã theo các nhóm: tài khoản, chủ đề/màn chơi, gameplay và tiến độ.}

\subsection{Quy trình chơi / activity diagram}
...
\thesistodo{vẽ biểu đồ hoạt động cho quy trình chơi tại đây. Các bước chính nên là: Mở game, Chọn tài khoản, Chọn chủ đề, Chọn màn, Sinh bảng, Chọn gợi ý, Nhập đáp án, Kiểm tra đáp án, Nếu đúng thì mở từ và cộng điểm, Nếu sai thì cho nhập lại, Nếu đủ sao thì dùng gợi ý, Khi hoàn thành thì lưu tiến độ và hiển thị kết quả.}
