...
\thesistodo{nếu muốn minh họa rõ hơn, thêm bảng ví dụ chuyển đổi từ gốc sang dạng xếp bảng. Ví dụ gồm các cột: Từ gốc, Dạng chuẩn hóa, Dạng xếp bảng, Số ô trên bảng.}
...
\thesistodo{vẽ lưu đồ thuật toán sinh bảng. Lưu đồ nên có các bước: tạo lưới rỗng, đặt từ đầu tiên, duyệt từng từ còn lại, tìm vị trí giao nhau, kiểm tra hợp lệ, chấm điểm vị trí, đặt từ, loại từ cô lập, trả về bảng.}
...
Godot và GDScript là các công nghệ trực tiếp dùng để xây dựng ứng dụng trò chơi. Ngoài ra, quá trình phát triển sử dụng Godot Editor và Visual Studio Code để chỉnh sửa project và mã nguồn.

LaTeX và Overleaf chỉ được sử dụng để biên soạn báo cáo đồ án. Các công cụ này hỗ trợ cấu trúc chương mục, danh mục bảng, tài liệu tham khảo và định dạng văn bản, nhưng không phải là công nghệ cốt lõi của sản phẩm game.

\thesistodo{nếu báo cáo yêu cầu ghi rõ môi trường soạn thảo, điền thêm phiên bản VS Code, MiKTeX hoặc cách bạn dùng Overleaf.}
